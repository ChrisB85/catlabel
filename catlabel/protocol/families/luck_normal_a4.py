...
A4_TATTOO_64_MODE_RECIPES = {
    PaperMode.PLAIN: LuckNormalModeRecipe(paper_mode=LuckNormalPaperMode.PLAIN),
    PaperMode.TAG: A4_MARKED_TAG_RECIPE,
    PaperMode.BLACK_TAG: A4_MARKED_BLACK_TAG_RECIPE,
    PaperMode.FOLDER: A4_MARKED_FOLDER_RECIPE,
    PaperMode.TATTOO: LuckNormalModeRecipe(paper_mode=LuckNormalPaperMode.TATTOO),
}
...
BASE_A4_MODE_RECIPES = {
    ...
    PaperMode.BLACK_TAG: A4_MARKED_BLACK_TAG_RECIPE,
    PaperMode.FOLDER: A4_MARKED_FOLDER_RECIPE,
    PaperMode.TATTOO: LuckNormalModeRecipe(paper_mode=LuckNormalPaperMode.PLAIN),
}
...
LUCKP_A4_MODE_RECIPES = {
    ...
    PaperMode.TAG: A4_MARKED_TAG_RECIPE,
    PaperMode.BLACK_TAG: A4_MARKED_BLACK_TAG_RECIPE,
    PaperMode.FOLDER: LuckNormalModeRecipe(finish_action="position"),
...
RECIPE = LuckNormalFamilyRecipe(
    ...
    variants={
        "luckp_a41": LuckNormalVariantRecipe(mode_recipes=LUCKP_A4_MODE_RECIPES),
        "luckp_a42": LuckNormalVariantRecipe(mode_recipes=LUCKP_A4_MODE_RECIPES),
        ...
        "u8": LuckNormalVariantRecipe(mode_recipes=A4_TATTOO_64_MODE_RECIPES),
        "apl86": LuckNormalVariantRecipe(mode_recipes=APL86_MODE_RECIPES),
        "d80": LuckNormalVariantRecipe(mode_recipes=D80_MODE_RECIPES),
        "d80h": LuckNormalVariantRecipe(mode_recipes=A4_TATTOO_64_MODE_RECIPES),
